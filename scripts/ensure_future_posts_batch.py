...
if __name__ == "__main__":
    ...
    print(f"Current future READY posts before ensure: {result['current_ready']}")
    print(f"Current future READY + WAITING_IMAGE posts before ensure: {result['current_future']}")
    print(f"WAITING_IMAGE posts pending batch submission: {result['pending_batch_submission']}")
